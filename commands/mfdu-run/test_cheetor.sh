...
function cheetor_vicuna_likelihood(){
...
function cheetor_vicuna_generation(){
    infer_method=generation
    formulation=TrueOrFalse
    model=cheetor
    model_name=models/interfaces/Cheetah/eval_configs/cheetah_eval_vicuna.yaml
...
function cheetor_llama2_likelihood(){
    infer_method=likelihood
    formulation=TrueOrFalse
    model=cheetor
...
function cheetor_llama2_generation(){
    infer_method=generation
    formulation=TrueOrFalse
    model=cheetor
    model_name=models/interfaces/Cheetah/eval_configs/cheetah_eval_llama2.yaml
...
cheetor_vicuna_likelihood
cheetor_vicuna_generation
cheetor_llama2_likelihood
cheetor_llama2_generation
