...
bash ./commands/mfdu-run/test_minigpt4.sh


conda activate mmgpt
bash ./commands/mfdu-run/test_mmgpt.sh


conda activate mplugowl
bash ./commands/mfdu-run/test_mplugowl.sh
