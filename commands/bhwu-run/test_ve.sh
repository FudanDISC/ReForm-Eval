...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name SNLI-VE --dataset_config datasets/configs/VisualEntailment_val.yaml \
    --output_dir output/bhwu_output/vem/blip2_t5/eval_ll_v1 \
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name SNLI-VE --dataset_config datasets/configs/VisualEntailment_val.yaml \
    --output_dir output/bhwu_output/vem/blip2_vicuna_instruct/eval_ll_v1 \
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name SNLI-VE --dataset_config datasets/configs/VisualEntailment_val.yaml \
    --output_dir output/bhwu_output/vem/blip2_t5_instruct/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name SNLI-VE --dataset_config datasets/configs/VisualEntailment_val.yaml \
    --output_dir output/bhwu_output/vem/minigpt4/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name SNLI-VE --dataset_config datasets/configs/VisualEntailment_val.yaml \
    --output_dir output/bhwu_output/vem/llava/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name SNLI-VE --dataset_config datasets/configs/VisualEntailment_val.yaml \
    --output_dir output/bhwu_output/vem/llava2/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name SNLI-VE --dataset_config datasets/configs/VisualEntailment_val.yaml \
    --output_dir output/bhwu_output/vem/mplugowl/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name SNLI-VE --dataset_config datasets/configs/VisualEntailment_val.yaml \
    --output_dir output/bhwu_output/vem/imagebindLLM/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name SNLI-VE --dataset_config datasets/configs/VisualEntailment_val.yaml \
    --output_dir output/bhwu_output/vem/llama_adapterv2/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name SNLI-VE --dataset_config datasets/configs/VisualEntailment_val.yaml \
    --output_dir output/bhwu_output/vem/mmgpt/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name SNLI-VE --dataset_config datasets/configs/VisualEntailment_val.yaml \
    --output_dir output/bhwu_output/vem/pandagpt/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name SNLI-VE --dataset_config datasets/configs/VisualEntailment_val.yaml \
    --output_dir output/bhwu_output/vem/shikra/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name SNLI-VE --dataset_config datasets/configs/VisualEntailment_val.yaml \
    --output_dir output/bhwu_output/vem/cheetor_vicuna/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name SNLI-VE --dataset_config datasets/configs/VisualEntailment_val.yaml \
    --output_dir output/bhwu_output/vem/cheetor_llama2/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name SNLI-VE --dataset_config datasets/configs/VisualEntailment_val.yaml \
    --output_dir output/bhwu_output/vem/bliva/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name SNLI-VE --dataset_config datasets/configs/VisualEntailment_val.yaml \
    --output_dir output/bhwu_output/vem/lynx/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
