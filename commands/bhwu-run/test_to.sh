...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name WikiHow --dataset_config datasets/configs/TemporalOrdering_val.yaml \
    --output_dir output/bhwu_output/wits/in-method/blip2_t5/eval_ll_v1 \
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name WikiHow --dataset_config datasets/configs/TemporalOrdering_val.yaml \
    --output_dir output/bhwu_output/wits/in-method/blip2_vicuna_instruct/eval_ll_v1 \
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name WikiHow --dataset_config datasets/configs/TemporalOrdering_val.yaml \
    --output_dir output/bhwu_output/wits/in-method/blip2_t5_instruct/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name WikiHow --dataset_config datasets/configs/TemporalOrdering_val.yaml \
    --output_dir output/bhwu_output/wits/in-method/minigpt4/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name WikiHow --dataset_config datasets/configs/TemporalOrdering_val.yaml \
    --output_dir output/bhwu_output/wits/in-method/llava/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name WikiHow --dataset_config datasets/configs/TemporalOrdering_val.yaml \
    --output_dir output/bhwu_output/wits/in-method/llava2/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name WikiHow --dataset_config datasets/configs/TemporalOrdering_val.yaml \
    --output_dir output/bhwu_output/wits/in-method/mplugowl/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name WikiHow --dataset_config datasets/configs/TemporalOrdering_val.yaml \
    --output_dir output/bhwu_output/wits/in-method/imagebindLLM/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name WikiHow --dataset_config datasets/configs/TemporalOrdering_val.yaml \
    --output_dir output/bhwu_output/wits/in-method/llama_adapterv2/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name WikiHow --dataset_config datasets/configs/TemporalOrdering_val.yaml \
    --output_dir output/bhwu_output/wits/in-method/mmgpt/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name WikiHow --dataset_config datasets/configs/TemporalOrdering_val.yaml \
    --output_dir output/bhwu_output/wits/in-method/pandagpt/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name WikiHow --dataset_config datasets/configs/TemporalOrdering_val.yaml \
    --output_dir output/bhwu_output/wits/in-method/shikra/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name WikiHow --dataset_config datasets/configs/TemporalOrdering_val.yaml \
    --output_dir output/bhwu_output/wits/in-method/cheetor_vicuna/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name WikiHow --dataset_config datasets/configs/TemporalOrdering_val.yaml \
    --output_dir output/bhwu_output/wits/in-method/cheetor_llama2/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name WikiHow --dataset_config datasets/configs/TemporalOrdering_val.yaml \
    --output_dir output/bhwu_output/wits/in-method/bliva/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name WikiHow --dataset_config datasets/configs/TemporalOrdering_val.yaml \
    --output_dir output/bhwu_output/wits/in-method/lynx/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
