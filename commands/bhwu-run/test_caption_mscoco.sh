...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --output_dir output/bhwu_output/caption/mscoco/blip2_t5/default_length \
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name MSCOCO --dataset_config build/configs/Caption_MSCOCO_val.yaml \
    --output_dir output/bhwu_output/caption/mscoco/blip2_vicuna_instruct/default_length \
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name MSCOCO --dataset_config build/configs/Caption_MSCOCO_val.yaml \
    --output_dir output/bhwu_output/caption/mscoco/blip2_t5_instruct/default_length \
    --infer_method generation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name MSCOCO --dataset_config build/configs/Caption_MSCOCO_val.yaml \
    --output_dir output/bhwu_output/caption/mscoco/minigpt4/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name MSCOCO --dataset_config build/configs/Caption_MSCOCO_val.yaml \
    --output_dir output/bhwu_output/caption/mscoco/llava/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name MSCOCO --dataset_config build/configs/Caption_MSCOCO_val.yaml \
    --output_dir output/bhwu_output/caption/mscoco/llava2/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name MSCOCO --dataset_config build/configs/Caption_MSCOCO_val.yaml \
    --output_dir output/bhwu_output/caption/mscoco/mplugowl/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name MSCOCO --dataset_config build/configs/Caption_MSCOCO_val.yaml \
    --output_dir output/bhwu_output/caption/mscoco/imagebindLLM/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name MSCOCO --dataset_config build/configs/Caption_MSCOCO_val.yaml \
    --output_dir output/bhwu_output/caption/mscoco/llama_adapterv2/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name MSCOCO --dataset_config build/configs/Caption_MSCOCO_val.yaml \
    --output_dir output/bhwu_output/caption/mscoco/mmgpt/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name MSCOCO --dataset_config build/configs/Caption_MSCOCO_val.yaml \
    --output_dir output/bhwu_output/caption/mscoco/pandagpt/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name MSCOCO --dataset_config build/configs/Caption_MSCOCO_val.yaml \
    --output_dir output/bhwu_output/caption/mscoco/shikra/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name MSCOCO --dataset_config build/configs/Caption_MSCOCO_val.yaml \
    --output_dir output/bhwu_output/caption/mscoco/cheetor_vicuna/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name MSCOCO --dataset_config build/configs/Caption_MSCOCO_val.yaml \
    --output_dir output/bhwu_output/caption/mscoco/cheetor_llama2/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name MSCOCO --dataset_config build/configs/Caption_MSCOCO_val.yaml \
    --output_dir output/bhwu_output/caption/mscoco/bliva/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name MSCOCO --dataset_config build/configs/Caption_MSCOCO_val.yaml \
    --output_dir output/bhwu_output/caption/mscoco/lynx/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
