...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --output_dir output/bhwu_output/caption/nocaps/blip2_t5/default_length \
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name NoCaps --dataset_config build/configs/Caption_NoCaps_val.yaml \
    --output_dir output/bhwu_output/caption/nocaps/blip2_vicuna_instruct/default_length \
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name NoCaps --dataset_config build/configs/Caption_NoCaps_val.yaml \
    --output_dir output/bhwu_output/caption/nocaps/blip2_t5_instruct/default_length \
    --infer_method generation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name NoCaps --dataset_config build/configs/Caption_NoCaps_val.yaml \
    --output_dir output/bhwu_output/caption/nocaps/minigpt4/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name NoCaps --dataset_config build/configs/Caption_NoCaps_val.yaml \
    --output_dir output/bhwu_output/caption/nocaps/llava/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name NoCaps --dataset_config build/configs/Caption_NoCaps_val.yaml \
    --output_dir output/bhwu_output/caption/nocaps/llava2/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name NoCaps --dataset_config build/configs/Caption_NoCaps_val.yaml \
    --output_dir output/bhwu_output/caption/nocaps/mplugowl/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name NoCaps --dataset_config build/configs/Caption_NoCaps_val.yaml \
    --output_dir output/bhwu_output/caption/nocaps/imagebindLLM/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name NoCaps --dataset_config build/configs/Caption_NoCaps_val.yaml \
    --output_dir output/bhwu_output/caption/nocaps/llama_adapterv2/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name NoCaps --dataset_config build/configs/Caption_NoCaps_val.yaml \
    --output_dir output/bhwu_output/caption/nocaps/mmgpt/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name NoCaps --dataset_config build/configs/Caption_NoCaps_val.yaml \
    --output_dir output/bhwu_output/caption/nocaps/pandagpt/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name NoCaps --dataset_config build/configs/Caption_NoCaps_val.yaml \
    --output_dir output/bhwu_output/caption/nocaps/shikra/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name NoCaps --dataset_config build/configs/Caption_NoCaps_val.yaml \
    --output_dir output/bhwu_output/caption/nocaps/cheetor_vicuna/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name NoCaps --dataset_config build/configs/Caption_NoCaps_val.yaml \
    --output_dir output/bhwu_output/caption/nocaps/cheetor_llama2/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name NoCaps --dataset_config build/configs/Caption_NoCaps_val.yaml \
    --output_dir output/bhwu_output/caption/nocaps/bliva/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --dataset_name NoCaps --dataset_config build/configs/Caption_NoCaps_val.yaml \
    --output_dir output/bhwu_output/caption/nocaps/lynx/default_length \
    --infer_method generation --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation Generation \
    --dataset_duplication 1 --max_new_tokens $MAX_NEW_TOKENS
