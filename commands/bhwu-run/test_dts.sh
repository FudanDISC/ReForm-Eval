...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MEDIC --dataset_config datasets/configs/DisasterType_val.yaml \
    --output_dir output/bhwu_output/dts/blip2_t5/eval_ll_v1 \
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MEDIC --dataset_config datasets/configs/DisasterType_val.yaml \
    --output_dir output/bhwu_output/dts/blip2_vicuna_instruct/eval_ll_v1 \
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MEDIC --dataset_config datasets/configs/DisasterType_val.yaml \
    --output_dir output/bhwu_output/dts/blip2_t5_instruct/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MEDIC --dataset_config datasets/configs/DisasterType_val.yaml \
    --output_dir output/bhwu_output/dts/minigpt4/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MEDIC --dataset_config datasets/configs/DisasterType_val.yaml \
    --output_dir output/bhwu_output/dts/llava/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MEDIC --dataset_config datasets/configs/DisasterType_val.yaml \
    --output_dir output/bhwu_output/dts/llava2/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MEDIC --dataset_config datasets/configs/DisasterType_val.yaml \
    --output_dir output/bhwu_output/dts/mplugowl/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MEDIC --dataset_config datasets/configs/DisasterType_val.yaml \
    --output_dir output/bhwu_output/dts/imagebindLLM/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MEDIC --dataset_config datasets/configs/DisasterType_val.yaml \
    --output_dir output/bhwu_output/dts/llama_adapterv2/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MEDIC --dataset_config datasets/configs/DisasterType_val.yaml \
    --output_dir output/bhwu_output/dts/mmgpt/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MEDIC --dataset_config datasets/configs/DisasterType_val.yaml \
    --output_dir output/bhwu_output/dts/pandagpt/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MEDIC --dataset_config datasets/configs/DisasterType_val.yaml \
    --output_dir output/bhwu_output/dts/shikra/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MEDIC --dataset_config datasets/configs/DisasterType_val.yaml \
    --output_dir output/bhwu_output/dts/cheetor_vicuna/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MEDIC --dataset_config datasets/configs/DisasterType_val.yaml \
    --output_dir output/bhwu_output/dts/cheetor_llama2/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MEDIC --dataset_config datasets/configs/DisasterType_val.yaml \
    --output_dir output/bhwu_output/dts/bliva/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
