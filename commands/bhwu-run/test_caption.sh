...
#     --dataset_name Flickr30K --dataset_config build/configs/Caption_val.yaml \
...
CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node=2 run_eval.py \
    --model blip2  --model_name blip2_t5 --model_type pretrain_flant5xl \
    --dataset_name MSCOCO --dataset_config build/configs/Caption_val.yaml \
...
CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node=2 run_eval.py \
    --model blip2  --model_name blip2_t5  --model_type pretrain_flant5xl \
    --dataset_name TextCaps --dataset_config build/configs/Caption_val.yaml \
...
CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node=2 run_eval.py \
    --model blip2  --model_name blip2_t5  --model_type pretrain_flant5xl \
    --dataset_name NoCaps --dataset_config build/configs/Caption_val.yaml \
