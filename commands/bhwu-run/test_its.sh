...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MSCOCO --dataset_config datasets/configs/ImageTextSelection_val.yaml \
    --output_dir output/bhwu_output/its/blip2_t5/eval_ll_v1 \
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MSCOCO --dataset_config datasets/configs/ImageTextSelection_val.yaml \
    --output_dir output/bhwu_output/its/blip2_vicuna_instruct/eval_ll_v1 \
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MSCOCO --dataset_config datasets/configs/ImageTextSelection_val.yaml \
    --output_dir output/bhwu_output/its/blip2_t5_instruct/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MSCOCO --dataset_config datasets/configs/ImageTextSelection_val.yaml \
    --output_dir output/bhwu_output/its/minigpt4/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MSCOCO --dataset_config datasets/configs/ImageTextSelection_val.yaml \
    --output_dir output/bhwu_output/its/llava/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MSCOCO --dataset_config datasets/configs/ImageTextSelection_val.yaml \
    --output_dir output/bhwu_output/its/llava2/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MSCOCO --dataset_config datasets/configs/ImageTextSelection_val.yaml \
    --output_dir output/bhwu_output/its/mplugowl/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MSCOCO --dataset_config datasets/configs/ImageTextSelection_val.yaml \
    --output_dir output/bhwu_output/its/imagebindLLM/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MSCOCO --dataset_config datasets/configs/ImageTextSelection_val.yaml \
    --output_dir output/bhwu_output/its/llama_adapterv2/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MSCOCO --dataset_config datasets/configs/ImageTextSelection_val.yaml \
    --output_dir output/bhwu_output/its/mmgpt/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MSCOCO --dataset_config datasets/configs/ImageTextSelection_val.yaml \
    --output_dir output/bhwu_output/its/pandagpt/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MSCOCO --dataset_config datasets/configs/ImageTextSelection_val.yaml \
    --output_dir output/bhwu_output/its/shikra/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MSCOCO --dataset_config datasets/configs/ImageTextSelection_val.yaml \
    --output_dir output/bhwu_output/its/cheetor_vicuna/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MSCOCO --dataset_config datasets/configs/ImageTextSelection_val.yaml \
    --output_dir output/bhwu_output/its/cheetor_llama2/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MSCOCO --dataset_config datasets/configs/ImageTextSelection_val.yaml \
    --output_dir output/bhwu_output/its/bliva/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE torchrun --nproc_per_node=$NPROC_PER_NODE --master_port=$MASTER_PORT run_eval.py \
    ...
    --in_context_sample \
    --dataset_name MSCOCO --dataset_config datasets/configs/ImageTextSelection_val.yaml \
    --output_dir output/bhwu_output/its/lynx/eval_ll_v1 \
    --infer_method $INFER_METHOD --half_evaluation \
    --per_gpu_eval_batch_size 1 --formulation SingleChoice \
    --do_eval --dataset_duplication 5
