...
class OCROpenEndedMetric(object):
    ...
    def __call__(self, prediction, answer, options=None):
        ...
        if self.has_word(answer, gt_answers):
            return 1, prediction
        else:
            return 0, prediction

    def has_word(self, sentence, word):
...
class KIEOpenEndedMetric(object):
    def __init__(self):
        self.contractions = {
            "aint": "ain't",
            "arent": "aren't",
    ...
    def __call__(self, answer, gt_answers, options=None):
        ...
        if type(gt_answers)==list:
            for i in range(len(gt_answers)):
                ...
                if self.has_word(answer, gt_answers[i]):
                    return 1
            return 0
        else:
