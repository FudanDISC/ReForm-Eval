...
class LLaMA_adapter(nn.Module):
    ...
    def __init__(self, llama_ckpt_dir, llama_tokenizer,
        ...
        self.count_trainability(self.phase)
    ...
    def count_trainability(self, phase='finetune'):
    ...
    def generate(
        ...
        #     print('i',i)
        #     print('j',len(j))
        #     print(torch.tensor(j).cuda().long().shape)
        #     print(total_len)
...
def load(name, llama_dir, device="cuda" if torch.cuda.is_available() else "cpu", download_root='ckpts', max_seq_len=1024,
        phase="finetune"):
    if name in _MODELS:
    ...
    return model, model.clip_transform
