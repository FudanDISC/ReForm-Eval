...
class VizWiz_Dataset(Dataset):
    def __init__(self , args , config='build/configs/ImageQuality_vizwiz_val.yaml' , proc=None , duplication=1):
        if type(config) == str:
        ...
        if self.args.hf:
            ...
            if self.config['task_kind'] == 'SingleChoice':
                ...
                self.anns_path = self.config['data_config']['yesNo_anns_path']
...
if __name__ == '__main__':
    ds = VizWiz_Dataset(args='' , duplication=1)
