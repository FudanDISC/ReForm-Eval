...
class GroundedObjIden_SingleChoice(Dataset):
    # the single-choice version of the visual Dialog dataset
    def __init__(self, args, config='datasets/configs/GroundedObjIdentification_val.yaml', proc=None, duplication=1):
        if type(config) == str:
...
if __name__=='__main__':
    ds = GroundedObjIden_SingleChoice(args='')
