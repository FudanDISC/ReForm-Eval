...
class MultiClassIden_SingleChoice(Dataset):
    # the single-choice version of the visual Dialog dataset
    def __init__(self, args, config='datasets/configs/MulticlassIdentification_val.yaml', proc=None, duplication=1):
        if type(config) == str:
