...
class ObjectGrounding_SingleChoice(Dataset):
    # the single-choice version of the visual Dialog dataset
    def __init__(self, args, config='datasets/configs/ObjectGrounding_val.yaml', proc=None, duplication=1):
        if type(config) == str:
...
class ObjectGrounding_TrueOrFlase(Dataset):
...
if __name__=='__main__':
    ds = ObjectGrounding_SingleChoice(args='')
