...
class Pets37_Dataset(Dataset):
    def __init__(self , args , config='build/configs/ImageClassification_pets37_val.yaml' , proc=None , duplication=1):
        if type(config) == str:
    ...
    def __getitem__(self , idx):
        ...
        image_path = os.path.join(self.image_dir , data_item['image_name'])
...
if __name__ == '__main__':
    ds = Pets37_Dataset(args='' , duplication=1)
